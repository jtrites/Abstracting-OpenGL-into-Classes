...
/****** Create a windowed mode window and its OpenGL context 
    ...
    /* Create a New Scope {...} FROM Here TO BEFORE glfwTerminate(); */
    {
        ...
        /* Vid#10: (20:30) wrap GLCall() around these (3) gl calls
            ...
            /* Vid#13: (18:40) Delete OR Comment Out VertexBuffer creation code,
                move to the new VertexBuffer Class, and replace with: */
     ...
     /*** Vid#5 - OpenGL Vertex Layout Attributes - use attribute pointers to GPU Memory Layout
